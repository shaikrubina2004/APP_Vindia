  ...
  return (
    <NotificationProvider>
      <Routes>
        ...
        {/* ══ HR ════════════════════════════════════════════ */}
        <Route path="/hr"                element={<ProtectedRoute allowedRoles={[ROLES.HR_MANAGER, ROLES.CEO]}><HRLayout><HRDashboard /></HRLayout></ProtectedRoute>} />
        <Route path="/hr/employees"      element={<ProtectedRoute allowedRoles={[ROLES.HR_MANAGER, ROLES.CEO]}><HRLayout><Employees /></HRLayout></ProtectedRoute>} />
        <Route path="/hr/add-employee"   element={<ProtectedRoute allowedRoles={[ROLES.HR_MANAGER, ROLES.CEO]}><HRLayout><AddEmployee /></HRLayout></ProtectedRoute>} />
        <Route path="/hr/employee/:id"   element={<ProtectedRoute allowedRoles={[ROLES.HR_MANAGER, ROLES.CEO]}><HRLayout><EmployeeDetails /></HRLayout></ProtectedRoute>} />
        <Route path="/hr/attendance"     element={<ProtectedRoute allowedRoles={[ROLES.HR_MANAGER, ROLES.CEO]}><HRLayout><Attendance /></HRLayout></ProtectedRoute>} />
        <Route path="/hr/documents"      element={<ProtectedRoute allowedRoles={[ROLES.HR_MANAGER, ROLES.CEO]}><HRLayout><Documents /></HRLayout></ProtectedRoute>} />
        <Route path="/hr/payroll"        element={<ProtectedRoute allowedRoles={[ROLES.HR_MANAGER, ROLES.CEO]}><HRLayout><Payroll /></HRLayout></ProtectedRoute>} />
        <Route path="/hr/travel"         element={<ProtectedRoute allowedRoles={[ROLES.HR_MANAGER, ROLES.CEO]}><HRLayout><Travel /></HRLayout></ProtectedRoute>} />
        <Route path="/hr/leaves"         element={<ProtectedRoute allowedRoles={[ROLES.HR_MANAGER, ROLES.CEO]}><HRLayout><Leaves /></HRLayout></ProtectedRoute>} />
...
/>
        ...
        />
        <Route path="/bda/leads"     element={<ProtectedRoute allowedRoles={[ROLES.CEO, ROLES.BDA]}><BDALayout><BDALeads /></BDALayout></ProtectedRoute>} />
        <Route path="/bda/add-lead"  element={<ProtectedRoute allowedRoles={[ROLES.CEO, ROLES.BDA]}><BDALayout><BDAAddLead /></BDALayout></ProtectedRoute>} />
        <Route path="/bda/follow-up" element={<ProtectedRoute allowedRoles={[ROLES.CEO, ROLES.BDA]}><BDALayout><BDAFollowUp /></BDALayout></ProtectedRoute>} />
        <Route path="/bda/reports"   element={<ProtectedRoute allowedRoles={[ROLES.CEO, ROLES.BDA]}><BDALayout><BDAReportsWithRole /></BDALayout></ProtectedRoute>} />

        {/* ══ FALLBACK ══════════════════════════════════════ */}
        <Route path="*" element={<h2 style={{ padding: 40, textAlign: "center" }}>404 — Page Not Found</h2>} />
