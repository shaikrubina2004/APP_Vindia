...
/* ── Category list — kept identical to BudgetPlanning.jsx so an
   expense's category matches a budget's category and the backend
   spent_amount recalculation continues to work correctly. ─────── */
...
export default function ExpenseTracking() {
  ...
  const [filterExpenseType, setFilterExpenseType] =
    useState("all");
  ...
  const handleSave = async () => {
    ...
    if (Number(form.amount) <= 0) {
      setFormError("Expense amount must be greater than zero."); return;
    }
    ...
    try {
      if (editingExpense?.id) {
        await financeService.updateExpense(editingExpense.id, payload);
      } else {
      ...
      console.error(editingExpense ? "Failed to update expense:" : "Failed to save expense:", err);
      setFormError(err?.response?.data?.message || (editingExpense ? "Failed to update expense" : "Failed to save expense"));
  ...
  const totalBudget =
    budgetVsActual.reduce(
      (s, c) =>
        s + Number(c.allocated || 0),
      0
    );
  ...
  return (
    ...
    >
      ...
      <div className="et-header">
        <div>
          ...
          <p className="et-subtitle">
            {isAccountant
              ? "Record, monitor and maintain company & project expenses"
              : "Track company & project expenses"}
          </p>
        </div>
      ...
      <div className="et-summary">
        <div
          className="et-summary-card"
          style={{
            "--accent": "#0A4174",
          }}
        >
          <p className="et-summary-label">
            Total Budget
          </p>

          <p className="et-summary-value">
            {fmt(totalBudget)}
          </p>

          <span className="et-summary-sub">
      ...
      {showForm && (
        <div className="et-form-card">
          ...
          {isAccountant && (
            ...
            >
              {editingExpense
                ? "Update the expense details accurately. Approval is handled through the finance approval workflow."
                : "Record the expense accurately. Approval is handled through the finance approval workflow."}
            </p>
          )}
              ...
              {[
                {
                  ...
                  label:
                    "Project Expense",
                  description:
                    "Materials, labour, equipment for projects",
                },
                {
                  key: "company",
                  label:
                    "Company Expense",
                  description:
                    "Office rent, salaries, utilities, etc.",
                },
              ].map((t) => (
                <div
                  key={t.key}
              ...
              (cat) => {
                ...
                return (
                  <div
                    ...
                    className={`et-category-card et-category-card--${status}`}
                  >
                    ...
                    <div className="et-cat-header">
                      ...
                      <div className="et-cat-info">
                        ...
                        <p className="et-cat-name">
                          {cat.name}
                        </p>

                        <p className="et-cat-spent">
                          {fmt(
                            cat.spent
                          )}{" "}
                          of{" "}
                    ...
                    <div className="et-progress-bar">
                      ...
                      <div
                        className={`et-progress-fill et-progress--${status}`}
                        style={{
                          width: `${used}%`,
                        }}
                      />
                    ...
                    <div className="et-cat-footer">
                      ...
                      <span className="et-cat-remaining">
                        {fmt(
                          cat.budget -
                            cat.spent
                        )}{" "}
                      ...
                      <span
                        className={`et-status et-status--${status}`}
                      >
                        {status ===
                        "ok"
                          ? "On Track"
          ...
          <div className="et-expense-list">
            ...
            {recentExpenses.map(
              (exp) => (
                <div
                  key={exp.id}
                  className="et-expense-item"
                >

                  <div className="et-exp-left">

                    <div
                      className="et-exp-dot"
                      style={{
                        background:
                          getStatusColor(
                            exp.status
                    ...
                    <div className="et-exp-info">
                      ...
                      <p className="et-exp-vendor">
                        {exp.vendor_name ||
                          "No vendor"}
                      </p>

                      <p className="et-exp-meta">
                        {exp.category}{" "}
                        •{" "}
                        {formatDate(
                          exp.expense_date
                  ...
                  <div className="et-exp-right">
                    ...
                    <p className="et-exp-amount">
                      {fmt(exp.amount)}
                    </p>

                    <span
                      className="et-exp-status"
                      style={{
                        background:
                          getStatusBg(
                            exp.status
            ...
            {filteredExpenses.map(
              (exp) => (
                ...
                >
                  ...
                  <td className="et-date">
                    {formatDate(
                      exp.expense_date
                    )}
                  </td>

                  <td className="et-vendor">
                    {exp.vendor_name ||
                      "—"}
                  </td>

                  <td className="et-receipt">
                    {exp.receipt_url ||
                      "—"}
                  </td>
              ...
              return (
                ...
                >
                  ...
                  <div className="et-budget-amounts">
                    ...
                    <div>
                      <span className="et-budget-label">
                        Budget
                      </span>

                      <p className="et-budget-val">
                        {fmt(
                          c.budget
                        )}
                      </p>
                  ...
                  <p className="et-budget-percentage">
                    {used}% utilised
                  </p>
                    ...
                    >
                      ...
                      <td>
                        ...
                        <div className="et-mini-bar">
                          ...
                          <div
                            className={`et-mini-fill et-mini-fill--${status}`}
                            style={{
                              width: `${used}%`,
                            }}
                          />
                        ...
                        <span
                          className={`et-mini-pct et-mini-pct--${status}`}
                        >
                          {used}%
                        </span>
        ...
        <div className="et-dept-cards">
          ...
          {withPct.map(
            (g) => (
              <div
                key={g.name}
                className="et-dept-card"
              >

                <div className="et-dept-header">

                  <p className="et-dept-name">
                    {g.name}
                  </p>

                  <span className="et-dept-pct">
                    {g.percentage}%
                  </span>

                </div>

                <p className="et-dept-amount">
                  {fmt(
                    g.total
                  )}
                </p>
