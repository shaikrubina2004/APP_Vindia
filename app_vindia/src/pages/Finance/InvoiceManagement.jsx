...
function AllInvoicesTab({
  ...
  const handleDelete = async (
    ...
    if (
      !window.confirm(
        `Delete invoice ${inv.invoice_number}? This can't be undone.`
      )
    ) {
      return;
    }
    ...
    try {
      await financeService.deleteInvoice(
        inv.id
      );
                ...
                >
                  ...
                  >
                    <div className="inv-actions">
                      ...
                      {/* View */}
                      <button
                        className="inv-act-btn inv-act-btn--view"
                        title="View"
                        onClick={() =>
                          setSelected(
                            inv
                      ...
                      {/* Edit — Finance Manager / CEO only */}
                      {!isAccountant && (
                        <button
                          className="inv-act-btn inv-act-btn--edit"
                          title="Edit"
                          onClick={() =>
                            setEditing(
                              inv
                      ...
                      {/* Delete — Finance Manager / CEO only */}
                      {!isAccountant && (
                        <button
                          className="inv-act-btn inv-act-btn--del"
                          title="Delete"
                          onClick={() =>
                            handleDelete(
                              inv
        ...
        await financeService.createInvoice(
          {
             ...
             * both create invoices initially
             * as pending.
             */
            status:
              "pending",
        ...
        <div className="inv-form-col">
          ...
          <section className="inv-section">
            ...
            <div className="inv-form-row">
              ...
              <input
                className="inv-input"
                placeholder="e.g. Skyline Infra Pvt Ltd"
                value={
                  form.client_name
                }
                onChange={(e) =>
            ...
            {form.items.map(
              (item, idx) => (
                ...
                >
                  ...
                  <input
                    className="inv-input inv-input--desc"
        ...
        <div className="inv-preview-col">
          ...
          <div className="inv-preview">
            ...
            <div className="inv-preview-top">
              ...
              <div>
                <p className="inv-preview-company">
                  VINDIA
                </p>

                <p className="inv-preview-label">
                  INVOICE
                </p>
              </div>
            ...
            <div className="inv-preview-to">
              ...
              <p className="inv-preview-to-label">
                BILL TO
              </p>

              <p className="inv-preview-to-name">
                {form.client_name ||
                  "Client Name"}
              </p>
...
function PendingInvoicesTab({
  ...
  const handleMarkPaid =
    async (inv) => {
      ...
      try {
        await financeService.updateInvoiceStatus(
          inv.id,
          "paid"
        );
      ...
      <div className="inv-pending-cards">
        ...
        {shown.map((inv) => {
          ...
          return (
            <div
              key={inv.id}
              className={`inv-pcard inv-pcard--${invoiceStatus}`}
            >
              ...
              <div className="inv-pcard-top">
                ...
                <div>
                  ...
                  <p className="inv-pcard-id">
                    {
                      inv.invoice_number
                    }
                  </p>

                  <p className="inv-pcard-client">
                    {
                      inv.client_name ||
                      "—"
                    }
              ...
              <div className="inv-pcard-bottom">
                ...
                <span className="inv-pcard-due">
                  ...
                  {invoiceStatus ===
                    "overdue" && (
                    <strong className="inv-pcard-overdue-tag">
                      {" "}
                      ·{" "}
                      {days}d
                      overdue
    ...
    >
      ...
      >
        ...
        <div className="inv-drawer-footer">
          ...
          {/* Delete only for Finance Manager / CEO */}
...
function StatusBadge({
  ...
  return (
    <span
      className={`inv-badge inv-badge--${status}`}
    >
      {status
        .charAt(0)
        .toUpperCase() +
...
function Row({
  ...
  return (
    <div className="inv-drawer-row">
      ...
      <span className="inv-drawer-label">
        {label}
      </span>

      <span className="inv-drawer-value">
        {value}
      </span>
