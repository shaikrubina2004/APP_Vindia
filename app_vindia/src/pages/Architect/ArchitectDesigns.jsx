...
const createSeedProject = () => ({
  ...
  drawings: [makeDrawing({
    id: "DWG-001", project: "", name: "Tower A Working Drawing",
...
const initialState = {
  projects: [],
  selectedProjectId: "", selectedDrawingId: "",
  search: "", projectFilter: "All", statusFilter: "All",
  modal: null, toast: null,
  uploadForm: {
    file: null, project: "", projectStatus: "Pending",
...
setAssignedProjects(mapped);
  ...
  totalDrawings: state.projects.reduce(
    (s, p) => s + p.drawings.length,
    0
  ),
 ...
 const handleWorkflowAction = (step, actionType, returnedFile = null) => {
  ...
  <select
    ...
    onChange={(e) =>
      dispatch({ type: "SET_UPLOAD_FORM", field: "project", value: e.target.value })
    }
  >
