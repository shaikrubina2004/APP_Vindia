...
export default function ProjectSwitcher() {
  ...
  // Prevent crashes if project context is not ready
    ...
    <div className="project-switcher-wrap" ref={ref}>
      ...
      {open && (
        <div className="ps-dropdown">
          <div className="ps-dropdown-label">
            Switch Project
          </div>
