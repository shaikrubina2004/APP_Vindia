...
async function safeNotify(
  ...
  try {
    ...
    console.log(
      `✅ PC Notification → user:${userId} type:${type} title:${title}`,
    );
  } catch (err) {
...
async function safeQSNotify(
  ...
  try {
    ...
    console.log(
      `✅ QS Notification → user:${userId} type:${type} title:${title}`,
    );
  } catch (err) {
